                ...
                <div id="hide-table">
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                              ...
                              <tr>
                                  ...
                                  <td data-title="{{ trans('section_lang.section_teacher_name') }}">{{ $section->teacher($section->teacher_id)->name }}</td>
                                  <td data-title="{{ trans('section_lang.section_classes') }}">{{ $section->isclass($section->class_id)->title }}</td>
