              ...
              <div class="row">
                  <div class="col-lg-12">
                      ...
                      <ul class="breadcrumb">
                          ...
                          <li class="active">{{ trans('topbar_menu_lang.menu_message') }} ({{ trans('mailandsms_lang.mailandsms_bulk') }})</li>
                      </ul>
                      <!--breadcrumbs end -->
                  </div>
              </div>
              ...
              <div class="col-lg-12">
                      ...
                      <section class="panel">
                          <header class="panel-heading">
                             {{ trans('topbar_menu_lang.menu_message') }} ({{ trans('mailandsms_lang.mailandsms_bulk') }})
                          </header>
                    ...
                    {!! Form::open(array('url'=>'messages/send_bulk_student','id'=>'demo-form2','class'=>'form-horizontal form-label-left' ,'role'=>'form','method'=>'POST', 'files'=>true)) !!}
                  ...
                  <div class="col-lg-9">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-lg-10">
                                                      ...
                                                      <input type="hidden" name="from" class="form-control" id="inputPassword1" placeholder="" value="{{ Auth::user()->id }}">
                                                      <input type="hidden" name="from_role" class="form-control" id="inputPassword1" placeholder="" value="admin">
                                                  </div>
                                              </div>
                                              <div class="form-group">
