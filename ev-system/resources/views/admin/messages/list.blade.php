                  ...
                  <aside class="lg-side">
                      <div class="inbox-head">
                          ...
                          <table class="table table-inbox table-hover">
                            <tbody>
                            @if(Auth::user())
                            @foreach( $messages->where('to',$authe->id)->where('to_role',$authe->role) as $message )
                              <tr class="<?php if ($message->active == 0) { echo "unread"; } ?>">
                               ...
                               @endforeach
                            @elseif(Auth::user())
                            @foreach( $messages->where('to',$authe->id)->where('to_role',"student") as $message )
                              <tr class="<?php if ($message->active == 0) { echo "unread"; } ?>">
                                  <td class="inbox-small-cells">
                                      <input type="checkbox" class="mail-checkbox">
                                  </td>
                                  ...
                                  <td class="view-message "><a href="{{ asset('student/messages/'.$message->id) }}">{{ $message->title }}</a></td>
                                  <td class="view-message  inbox-small-cells"><i class="fa fa-paperclip"></i></td>
                                  <td class="view-message  text-right">{{ $message->created_at }}</td>
                              </tr>
                               @endforeach
                            @elseif(Auth::user())
                            @foreach( $messages->where('to',$authe->id)->where('to_role',"teaching") as $message )
                              <tr class="<?php if ($message->active == 0) { echo "unread"; } ?>">
                                  <td class="inbox-small-cells">
                                      <input type="checkbox" class="mail-checkbox">
                                  </td>
                                  ...
                                  <td class="view-message "><a href="{{ asset('teacher/messages/'.$message->id) }}">{{ $message->title }}</a></td>
                                  <td class="view-message  inbox-small-cells"><i class="fa fa-paperclip"></i></td>
                                  <td class="view-message  text-right">{{ $message->created_at }}</td>
                              </tr>
                               @endforeach
                            @elseif(Auth::user())
                            @foreach( $messages->where('to',$authe->id)->where('to_role',"parent") as $message )
                              <tr class="<?php if ($message->active == 0) { echo "unread"; } ?>">
                                  <td class="inbox-small-cells">
                                      <input type="checkbox" class="mail-checkbox">
                                  </td>
                                  ...
                                  <td class="view-message "><a href="{{ asset('parent/messages/'.$message->id) }}">{{ $message->title }}</a></td>
                                  <td class="view-message  inbox-small-cells"><i class="fa fa-paperclip"></i></td>
                                  <td class="view-message  text-right">{{ $message->created_at }}</td>
                              </tr>
                               @endforeach
