              ...
              <div class="row">
                  <div class="col-lg-12">
                      ...
                      <ul class="breadcrumb">
                          ...
                          <li class="active">{{ trans('other.add_bulk_test') }}</li>
                      </ul>
                      <!--breadcrumbs end -->
                  </div>
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                      ...
                      <section class="panel">
                          ...
                          {{ trans('other.add_bulk_test') }}
                          </header>
                          <header class="panel-heading">
                          <a class="btn btn-primary" href="{{ url('ev-assets\uploads\sample-import\questions.csv') }}" style="margin:5px">
                                  Download Sample
                              </a>
                              </header>
                    ...
                    {!! Form::open(array('url'=>'store_bulk_test_question','id'=>'demo-form2','class'=>'form-horizontal form-label-left' ,'role'=>'form','method'=>'POST', 'files'=>true)) !!}
