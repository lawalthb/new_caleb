        ...
        <div class="col-lg-12">
            <section class="panel">
                    ...
                    <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                {!! Form::open(array('url'=>'store_online_test','id'=>'demo-form2','class'=>'form-horizontal' ,'role'=>'form','method'=>'POST', 'files'=>true)) !!}
                                <div class="modal-body">
                                <div class="form-group">
                                        <label  class="col-lg-2 control-label">{{ trans('other.can_redo_test') }}?
                                    </label>
                                    <div class="col-lg-9">
                                    ...
                                    <div class="form-group">
                                        <label  class="col-lg-2 control-label">{{ trans('other.duration') }} (in seconds)</label>
                                        <div class="col-lg-9">
                ...
                <div class="test-grid">
                    ...
                    <p>Can Redo Test: {{ $test->check_redo($test->redo) }}</p>
                    </div>
                    <a data-toggle="modal" href="#myModal2{{ $test->id }}" class="btn btn-primary">
                    Edit Test <i class="fa fa-pencil"></i>
                    <a data-toggle="modal" href="#myModaldel{{ $test->id }}" class="btn btn-danger pull-right">
                    ...
                    <div class="modal fade" id="myModal2{{ $test->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                {!! Form::open(array('url'=>'test/update_test','id'=>'demo-form2','class'=>'form-horizontal' ,'role'=>'form','method'=>'POST', 'files'=>true)) !!}
                                <div class="modal-body">
                                <div class="form-group">
