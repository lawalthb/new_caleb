                              ...
                              <section class="panel">
                                  ...
                                  <div class="panel-body">
                                      <div class="tab-content tasi-tab">
                                          ...
                                          {!! Form::open(array('url'=>'install/database','id'=>'demo-form2','class'=>'form-horizontal' ,'role'=>'form','method'=>'POST', 'files'=>true)) !!}
                                        ...
                                        <div class="form-group">
                                          <div class="row col-lg-9">
                                             <div class="col-sm-4 col-sm-offset-1">
                                                      <a href="{{ url('purchase_code') }}" class="btn btn-default pull-right">Previous Step</a>
                                                  </div>
