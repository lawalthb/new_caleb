            ...
            <div class="row">
                  <div class="col-lg-12">
                      ...
                      <ul class="breadcrumb">
                          ...
                          <li class="active">Edit's Parent Profile</li>
                      </ul>
                      <!--breadcrumbs end -->
                  </div>
              </div>
                  ...
                  <aside class="profile-nav col-lg-5">
                      <section class="panel">
                          ...
                          <ul class="nav nav-pills nav-stacked">
                              <li><a href="{{ url('parent/profile/'.$authe->id) }}"> <i class="fa fa-user"></i> Profile</a></li>
                              <li class="active"><a href="{{ url('parent/editprofile/'.$authe->id) }}"> <i class="fa fa-edit"></i> Edit profile</a></li>
                          </ul>
                  ...
                  <aside class="profile-info col-lg-7">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              <h1> Profile Info</h1>
                              {!! Form::open(array('url'=>'parent/editprofile','id'=>'demo-form2','class'=>'form-horizontal' ,'role'=>'form','method'=>'POST', 'files'=>true)) !!}
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <input type="phone" class="form-control" id="email" value="{{ Auth::user()->phone }}" name="phone">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" id="email" value="{{ Auth::user()->profession }}" name="profession">
                                      </div>
                                  </div>
                                  <div class="form-group">
                      ...
                      <section>
                          <div class="panel panel-primary">
                              ...
                              <div class="panel-body">
                                  {!! Form::open(array('url'=>'parent/editprofilepass','id'=>'demo-form2','class'=>'form-horizontal' ,'role'=>'form','method'=>'POST', 'files'=>true)) !!}
                                      <div class="form-group">
