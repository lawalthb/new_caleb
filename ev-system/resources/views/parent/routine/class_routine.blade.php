            ...
            <div class="row">
              ...
              <div class="row">
                  <div class="col-lg-12">
                      ...
                      @foreach( $classes->where('id',$student->class_id) as $class )
                      <div class="panel">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td data-title="">
                                    ...
                                    <div class="btn-group">
                                      <button type="button" class="btn btn-primary">{{ $classe->subject ? $classe->subject->title : '-' }} [{{ $classe->starts }} - {{ $classe->ends }}]</button>
