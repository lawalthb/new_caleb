...
<body onload="lll()">
  <div class="content-wrapper">
    ...
    <section class="content">
            <div class="row">
                  <div class="col-lg-12">
                      ...
                      <ul class="breadcrumb">
                          ...
                          <li class="active">{{ trans('sattendance_lang.panel_title2') }}</li>
                      </ul>
                      <!--breadcrumbs end -->
                  </div>
              </div>
        ...
        <tbody>
            <form method="post" action="{{ url('teacher/select_atendance') }}" class="form">
...
<?php
 ...
 if($get->count() > 0){ ?>
 <form method="post" 
    action="{{ url('teacher/attendance/update') }}/<?php echo $date.'/'.$month.'/'.$year.'/'.$class_id;?>">
       <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="col-sm-offset-3 col-md-6">
            <table  class="table table-bordered">
                <thead>
...
<form method="post" 
    action="{{ url('teacher/attendance') }}/<?php echo $date.'/'.$month.'/'.$year.'/'.$class_id;?>">
       <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="col-sm-offset-3 col-md-6">
            <table  class="table table-bordered">
                <thead>
