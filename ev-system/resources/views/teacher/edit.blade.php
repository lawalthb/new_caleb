                  ...
                  <aside class="profile-nav col-lg-5">
                      <section class="panel">
                          ...
                          <ul class="nav nav-pills nav-stacked">
                              <li><a href="{{ url('teacher/profile/'.$authe->id) }}"> <i class="fa fa-user"></i> Profile</a></li>
                              <li class="active"><a href="{{ url('teacher/editprofile/'.$authe->id) }}"> <i class="fa fa-edit"></i> Edit profile</a></li>
                          </ul>
                  ...
                  <aside class="profile-info col-lg-7">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              <h1> Profile Info</h1>
                              {!! Form::open(array('url'=>'teacher/editprofile','id'=>'demo-form2','class'=>'form-horizontal' ,'role'=>'form','method'=>'POST', 'files'=>true)) !!}
                      ...
                      <section>
                          <div class="panel panel-primary">
                              ...
                              <div class="panel-body">
                                  {!! Form::open(array('url'=>'teacher/editprofilepass','id'=>'demo-form2','class'=>'form-horizontal' ,'role'=>'form','method'=>'POST', 'files'=>true)) !!}
                                      <div class="form-group">
