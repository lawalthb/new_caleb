            ...
            <div class="row">
                  <div class="col-lg-12">
                      ...
                      <ul class="breadcrumb">
                          ...
                          <li class="active">Tests Questions</li>
                      </ul>
                      <!--breadcrumbs end -->
                  </div>
              </div>
                  ...
                  <div class="col-lg-12">
                              ...
                              <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          {!! Form::open(array('url'=>'teacher/add_test_question','id'=>'demo-form2','class'=>'form-horizontal' ,'role'=>'form','method'=>'POST', 'files'=>true)) !!}
                                          ...
                                          <div class="modal-footer">
                                              ...
                                              <button class="btn btn-warning" type="submit" name='submit'>Add Question</button>
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                              ...
                              <tr>
                                  ...
                                  <td data-title="Question">{{ $res->question }}</td>
                                  <td data-title="Option A">{{ $res->option_a }}</td>
                                  <td data-title="Option B">{{ $res->option_b }}</td>
                                  <td data-title="Option C">{{ $res->option_c }}</td>
                                  <td data-title="Option D">{{ $res->option_d }}</td>
                                  <td data-title="Correct Answer">{{ $res->correct_answer }}</td>
                              ...
                              <div class="modal fade" id="myModal2{{ $res->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          {!! Form::open(array('url'=>'admin/update_test_question','id'=>'demo-form2','class'=>'form-horizontal' ,'role'=>'form','method'=>'POST', 'files'=>true)) !!}
                                          <div class="modal-body">
                                              <div class="form-group">
                                                  <label  class="col-lg-2 control-label">Question</label>
                                                  <div class="col-lg-9">
                              ...
                              <div class="modal fade" id="myModaldel{{ $res->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                              <button data-dismiss="modal" class="btn btn-default" type="button">Close</button>
                                              <a href="{{ url('teacher/test_question/delete/'.$res->id) }}">
