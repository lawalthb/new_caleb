...
<html lang="en">
  <head>
	...
	<link href="<?php echo e(asset('ev-themes/default/dist/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet" type="text/css" media="all" />
	<link href="<?php echo e(asset('ev-themes/default/dist/custom.css')); ?>" rel="stylesheet" type="text/css" media="all" />
	<link href="<?php echo e(asset('ev-themes/default/dist/animate.css')); ?>" rel="stylesheet" type="text/css" media="all" />
  ...
  <body>
  	<nav class="navbar fixed-top navbar-expand-lg navbar-light" id="header">
		<div id="header-container" class="container navbar-container">
			...
			<a id="brand" class="navbar-brand" href=""><img src="<?php echo e(asset('ev-themes/default/images/logo.png')); ?>" alt=""> </a>
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
				<ul class="navbar-nav ml-auto mt-2 mt-lg-0">
					...
					<li class="nav-item dropdown">
						<a class="nav-link btn btn-default" href="<?php echo e(url('dashboard')); ?>">Login</a>
						<ul>
							<li><a href="<?php echo e(url('dashboard')); ?>">Admin Login</a></li>
							<li><a href="<?php echo e(url('dashboard')); ?>">Teacher Login</a></li>
							<li><a href="<?php echo e(url('dashboard')); ?>">Parent Login</a></li>
							<li><a href="<?php echo e(url('dashboard')); ?>">Student Login</a></li>
						</ul>
					</li>
				</ul>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					...
					<div class="review-bottom">
						<div class="review-avatar">
							<img src="<?php echo e(asset('ev-themes/default/images/user.png')); ?>" alt="">
						</div>
						<div>
				...
				<div class="col-md-6">
					...
					<div class="review-bottom">
						<div class="review-avatar">
							<img src="<?php echo e(asset('ev-themes/default/images/user.jpg')); ?>" alt="">
						</div>
						<div>
			...
			<div class="row">
				<div class="col-md-3 news-each">
					<div class="news-each-inner">
						<img src="<?php echo e(asset('ev-themes/default/images/thirdslide.jpg')); ?>" alt="">
				...
				<div class="col-md-3 news-each">
					<div class="news-each-inner">
						<img src="<?php echo e(asset('ev-themes/default/images/fifthslide.jpeg')); ?>" alt="">
						<div class="news-each-below">
				...
				<div class="col-md-3 news-each">
					<div class="news-each-inner">
						<img src="<?php echo e(asset('ev-themes/default/images/fourthslide.jpg')); ?>" alt="">
						<div class="news-each-below">
				...
				<div class="col-md-3 news-each">
					<div class="news-each-inner">
						<img src="<?php echo e(asset('ev-themes/default/images/firstslide.jpg')); ?>" alt="">
						<div class="news-each-below">
	...
	<script type="text/javascript" src="<?php echo e(asset('ev-themes/default/dist/jquery/jquery 3.3.1.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(asset('ev-themes/default/dist/bootstrap/js/bootstrap.min.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(asset('ev-themes/default/dist/custom.js')); ?>"></script>
  </body>
</html>
