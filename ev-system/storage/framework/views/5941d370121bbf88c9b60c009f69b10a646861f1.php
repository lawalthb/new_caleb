...
<?php echo e(trans('sattendance_lang.panel_title')); ?>
...
<body onload="lll()">
            <div class="row">
                  <div class="col-lg-12">
                      ...
                      <ul class="breadcrumb">
                          ...
                          <li class="active"><?php echo e(trans('sattendance_lang.panel_title')); ?></li>
                      </ul>
                      <!--breadcrumbs end -->
                  </div>
              </div>
        ...
        <thead>
            <tr>
                <th><?php echo e(trans('issue_lang.issue_select_day')); ?></th>
                <th><?php echo e(trans('issue_lang.issue_select_month')); ?></th>
                <th><?php echo e(trans('issue_lang.issue_select_year')); ?></th>
                <th><?php echo e(trans('sattendance_lang.attendance_select_classes')); ?></th>
                <th><?php echo e(trans('sattendance_lang.action')); ?></th>
           </tr>
       </thead>
        <tbody>
            <form method="post" action="<?php echo e(url('select_atendance')); ?>" class="form">
                ...
                <tr class="gradeA">
                    ...
                    <td data-title="">
                        <select name="class_id" class="form-control">
                            <option value=""><?php echo e(trans('sattendance_lang.attendance_select_classes')); ?></option>
                            <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="col-sm-offset-3 col-md-6">
        <table class="table table-bordered">
            ...
            <tbody>
                        ...
                        <tr class="gradeA">
                            <td data-title=""><?php echo e($student->name); ?></td>
                            
                            <td data-title=""><?php echo e($student->email); ?></td>
                            <td data-title="">
                            <?php 
...
<?php
 ...
 if($get->count() > 0){ ?>
 <form method="post" 
    action="<?php echo e(url('attendance/update')); ?>/<?php echo $date.'/'.$month.'/'.$year.'/'.$class_id;?>">
       <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
        <div class="col-sm-offset-3 col-md-6">
            <table  class="table table-bordered">
                <thead>
...
<form method="post" 
    action="<?php echo e(url('attendance')); ?>/<?php echo $date.'/'.$month.'/'.$year.'/'.$class_id;?>">
       <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
        <div class="col-sm-offset-3 col-md-6">
            <table  class="table table-bordered">
                <thead>
                        ...
                        <tr class="gradeA">
                            ...
                            <td align="center">
                                ...
                                if($at){
                                    ...
                                    ?>
                                <input type="hidden" name="stu[]" value="<?php echo e($student->id); ?>">
                                    <select name="status[]" class="form-control" style="width:100px; float:left;">
                                        <option value="0"></option>
                                        <option value="1">Present</option>
                                        <option value="0">Absent</option>
